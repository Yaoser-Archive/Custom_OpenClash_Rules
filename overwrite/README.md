...
1. **首选方案**：按照本项目 [Wiki](https://github.com/Yaoser-Archive/Custom_OpenClash_Rules/wiki) 中的设置方案，配合[配置模板（INI）](https://raw.githubusercontent.com/Yaoser-Archive/Custom_OpenClash_Rules/main/cfg/Custom_Clash.ini)进行配置
