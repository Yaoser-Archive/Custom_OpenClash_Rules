...
wget -qO- "https://cdn.jsdelivr.net/gh/Yaoser-Archive/Custom_OpenClash_Rules@refs/heads/${RULES_BRANCH}/shell/check_cpu_version.sh" | sh
```
...
```bash
RULES_BRANCH="${RULES_BRANCH:-main}"
wget -qO- "https://cdn.jsdelivr.net/gh/Yaoser-Archive/Custom_OpenClash_Rules@refs/heads/${RULES_BRANCH}/shell/install_openclash_dev.sh" | sh
```
...
```bash
RULES_BRANCH="${RULES_BRANCH:-main}"
wget -qO- "https://cdn.jsdelivr.net/gh/Yaoser-Archive/Custom_OpenClash_Rules@refs/heads/${RULES_BRANCH}/shell/install_openclash_dev_update.sh" | sh
```
